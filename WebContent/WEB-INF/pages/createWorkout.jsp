...
<body>
	...
	<div class="sidebar">
		<ul class="sidebar-menu">
			...
			<li class="sidebar-item"><a
				...
				class="sidebar-link active">Create Workout Plan</a></li>
		</ul>
	</div>
		...
		<div class="card">
			...
			<div class="card-body">
				<form id="createWorkoutForm"
					action="${pageContext.request.contextPath}/trainer/create-workout"
					method="post" novalidate>
					<div id="workoutValidationMessage"
						class="alert alert-danger workout-validation-error" role="alert"></div>
					<div class="form-group">
						<label for="memberId">Member</label> <select id="memberId"
							name="memberId" class="form-control"
							data-required-message="Please select a member.">
							...
							%>
							<option value="<%=member.getMemberId()%>"><%=member.getFullName()%>
								(<%=member.getEmail()%>)
							</option>
							<%
							}
					...
					<div class="form-group">
						<label for="planName">Plan Name</label> <input type="text"
							id="planName" name="planName" class="form-control"
							data-required-message="Please enter the plan name.">
						...
						<div class="col-6">
							<div class="form-group">
								<label for="startDate">Start Date</label> <input type="date"
									...
									data-required-message="Please choose a start date.">
						...
						<div class="col-6">
							<div class="form-group">
								<label for="endDate">End Date</label> <input type="date"
									...
									data-required-message="Please choose an end date.">
					...
					<div class="form-group">
						...
						<textarea id="exercises" name="exercises" class="form-control"
							rows="8"
							data-required-message="Please enter the exercises for this plan."></textarea>
					...
					<div class="d-flex justify-content-between">
						<a href="${pageContext.request.contextPath}/trainer/workouts"
	...
	<script>
		...
		var workoutMessage = document
				.getElementById('workoutValidationMessage');
		var requiredWorkoutFields = [ 'memberId', 'planName', 'startDate',
				'endDate', 'exercises' ];
