...
Double statusHeight = latestFitness != null && latestFitness.getHeightCm() != null
		? latestFitness.getHeightCm()
		: member != null ? member.getHeightCm() : null;
Double statusWeight = latestFitness != null && latestFitness.getWeightKg() != null
		? latestFitness.getWeightKg()
		: member != null ? member.getWeightKg() : null;
String statusGoal = latestFitness != null && latestFitness.getFitnessGoal() != null
		? latestFitness.getFitnessGoal()
	...
	<div class="sidebar">
		<ul class="sidebar-menu">
			<li class="sidebar-item"><a
				...
				class="sidebar-link active">Dashboard</a></li>
			<li class="sidebar-item"><a
	...
	<div class="main-content">
					...
					<div class="card-body">
						...
						<p>
							<strong>Status:</strong> <span
								class="badge <%=membershipActive ? "badge-success" : "badge-warning"%>"><%=membershipActive ? "Active" : "Expired"%></span>
						</p>
						<p>
							<strong>Type:</strong>
							<%=member.getMembershipType()%></p>
						<p>
							<strong>Joined:</strong>
							<%=member.getJoinDate() == null ? "" : dateUtil.formatDisplayDate(member.getJoinDate())%></p>
						<p>
							<strong>Expires:</strong>
							<%=member.getMembershipExpiryDate() == null ? "" : dateUtil.formatDisplayDate(member.getMembershipExpiryDate())%></p>
						<%
						}
						%>
					</div>
				...
				<div class="card">
					...
					<div class="card-body text-center">
						...
						<a href="${pageContext.request.contextPath}/member/checkin"
							class="btn btn-primary btn-lg">Check In Now</a>
					</div>
				</div>
			</div>
			...
			<div class="col-4">
				<div class="card">
					...
					<div class="card-body">
						...
						<p>
							<strong>Goal:</strong>
							<%=statusGoal == null || statusGoal.isBlank() ? "Not set" : statusGoal%></p>
						<p>
							<strong>Height:</strong>
							<%=statusHeight == null ? "Not set" : statusHeight + " cm"%></p>
						<p>
							<strong>Weight:</strong>
							<%=statusWeight == null ? "Not set" : statusWeight + " kg"%></p>
						<p>
							<strong>Body Fat:</strong>
							<%=latestFitness == null || latestFitness.getBodyFatPercent() == null
		? "Not set"
		: latestFitness.getBodyFatPercent() + "%"%></p>
						<p>
							<strong>Muscle Mass:</strong>
							<%=latestFitness == null || latestFitness.getMuscleMassKg() == null
		? "Not set"
		: latestFitness.getMuscleMassKg() + " kg"%></p>
						<p>
							<strong>BMI:</strong>
							<%=bmi == 0 ? "Not available" : String.format("%.1f", bmi) + " - " + bmiStatus%></p>
						<p>
		...
		<div class="card" style="margin-top: 20px;">
			...
			<div class="card-body">
				<div class="d-flex justify-content-between align-items-center"
					...
					<p class="text-muted" style="margin: 0;">Fitness records are
						added from My Profile.</p>
					<a href="${pageContext.request.contextPath}/member/profile"
						class="btn btn-outline btn-sm">Add Fitness Detail</a>
				</div>
				<div class="table-container">
					<table class="table">
						...
						<tbody>
							...
							%>
							<tr>
								<td colspan="8" class="text-center text-muted">No fitness
		...
		<div class="card" style="margin-top: 20px;">
			<div
				...
				<a href="${pageContext.request.contextPath}/member/workout"
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								...
								<td><span
									class="badge <%=plan.isActive() ? "badge-success" : "badge-secondary"%>">
										<%=plan.getStatus()%>
								</span></td>
							</tr>
							<%
