...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/style.css?v=forgot-fix-20">
<style>
.password-field {
	position: relative;
}
	...
	<div class="auth-container">
		<div class="auth-card">
			...
			<form id="resetPasswordForm"
				...
				<div id="resetValidationMessage"
					class="alert alert-danger reset-validation-error" role="alert"></div>
				...
				<div class="form-group">
					...
					<div class="password-field">
						<input type="password" id="password" name="password"
							class="form-control"
							data-required-message="Please enter a new password.">
				...
				<div class="form-group">
					...
					<div class="password-field">
						<input type="password" id="confirmPassword" name="confirmPassword"
							class="form-control"
							data-required-message="Please confirm your new password.">
						<button type="button" class="password-eye"
							data-target="confirmPassword" aria-label="Show confirm password"
			...
			<div class="auth-footer">
				<p>
					<a href="${pageContext.request.contextPath}/login">Back to Sign
						In</a>
				</p>
			</div>
		</div>
