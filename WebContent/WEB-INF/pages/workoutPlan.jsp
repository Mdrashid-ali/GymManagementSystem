...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/style.css?v=exercise-video-fixed-18">
<style>
.workout-card {
...
<body>
	...
	<div class="sidebar">
		<ul class="sidebar-menu">
			...
			<li class="sidebar-item"><a
				...
				class="sidebar-link active">Workout Plans</a></li>
		</ul>
	</div>
	<%
	} else if (isTrainer) {
	...
	<div class="main-content">
		<div class="d-flex justify-content-between align-items-center"
			...
			if (isTrainer) {
			%>
			<a href="${pageContext.request.contextPath}/trainer/create-workout"
				...
				<div class="row">
					<div class="col-6">
						<p>
							...
							<%=plan.getTrainerName()%></p>
						<%
						if (isTrainer) {
						%>
						<p>
							<strong>Member:</strong>
							<%=plan.getMemberName()%></p>
						<%
						}
						%>
						<p>
		...
		<div class="card">
			<div class="card-body text-center" style="padding: 60px;">
				...
				%>
				<a href="${pageContext.request.contextPath}/trainer/create-workout"
					class="btn btn-primary" style="margin-top: 20px;">Create First
					Workout Plan</a>
				<%
				} else {
				%>
	...
	<div class="video-panel" id="exerciseVideoPanel" aria-hidden="true">
		<div class="video-dialog">
			...
			<div class="video-frame-wrap">
				<iframe id="exerciseVideoFrame" title="Exercise video"
					allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
					allowfullscreen></iframe>
				<div class="video-message" id="exerciseVideoMessage">No
					embedded video is available for this exercise yet.</div>
			</div>
		</div>
	</div>
	<script>
		(function() {
			...
			var videoMap = [
					...
					{
						keys : [ 'push-up', 'push up', 'pushups', 'push-ups' ],
						id : 'IODxDxX7oi4'
					},
					{
						keys : [ 'dumbbell row', 'dumbbell rows', 'db row',
								'one arm row' ],
						id : 'roCP6wCXPqo'
					}, {
						keys : [ 'plank', 'planks' ],
						...
						keys : [ 'mountain climber', 'mountain climbers' ],
						id : 'nmwgirgXLYM'
					}, {
						keys : [ 'jumping jack', 'jumping jacks' ],
						id : 'c4DAnQ6DtF8'
					}, {
						keys : [ 'bicep curl', 'biceps curl', 'curl' ],
						id : 'ykJmrZ5v0Oo'
					}, {
						keys : [ 'shoulder press', 'overhead press' ],
						id : 'qEwKCR5JCog'
					} ];
			...
			function openVideo(exercise) {
				...
				if (videoId) {
					...
					message.textContent = 'No embedded video is available for '
							+ cleanExerciseName(exercise) + ' yet.';
				}
			...
			document
					.querySelectorAll('[data-video-exercises="true"]')
					.forEach(
							function(list) {
								var lines = list.innerHTML
										.split(/<br\s*\/?>/i)
										.map(
												function(line) {
													var temp = document
