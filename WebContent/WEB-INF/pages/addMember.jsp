...
<body>
	...
	<div class="sidebar">
		<ul class="sidebar-menu">
			...
			<li class="sidebar-item"><a
				...
				class="sidebar-link active">Add Member</a></li>
			<li class="sidebar-item"><a
		...
		<div class="card">
			...
			<div class="card-body">
				<form id="addMemberForm"
					action="${pageContext.request.contextPath}/admin/add-member"
					method="post" novalidate>
					<div id="memberValidationMessage"
						class="alert alert-danger member-validation-error" role="alert"></div>
					<div class="row">
						<div class="col-6">
							<div class="form-group">
								<label for="firstName">First Name *</label> <input type="text"
									id="firstName" name="firstName" class="form-control"
									data-required-message="Please enter the member first name.">
						...
						<div class="col-6">
							<div class="form-group">
								<label for="lastName">Last Name *</label> <input type="text"
									...
									data-required-message="Please enter the member last name.">
						...
						<div class="col-6">
							<div class="form-group">
								<label for="email">Email Address *</label> <input type="email"
									...
									data-required-message="Please enter the member email address.">
						...
						<div class="col-6">
							<div class="form-group">
								<label for="phone">Phone Number *</label> <input type="tel"
									...
									data-required-message="Please enter the member phone number.">
					...
					<div class="form-group">
						...
						<textarea id="fitnessGoal" name="fitnessGoal" class="form-control"
							rows="2" placeholder="e.g., Weight loss, Muscle gain, etc."></textarea>
					</div>
	...
	<script>
		...
		var requiredMemberFields = [ 'firstName', 'lastName', 'email', 'phone',
				'password' ];
				...
				.addEventListener(
						...
						function(event) {
							...
							if (emailInput.value.trim() !== ''
								...
								hasError = true;
								showMemberFieldError(emailInput,
							...
							if (passwordInput.value.trim() !== ''
								...
								hasError = true;
								showMemberFieldError(passwordInput,
										passwordRuleMessage);
								if (!firstInvalid) {
