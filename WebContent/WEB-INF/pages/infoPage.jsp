...
<body>
	...
	<div class="sidebar">
		<ul class="sidebar-menu">
			...
			<li class="sidebar-item"><a
				...
				class="sidebar-link">Attendance</a></li>
			<%
			} else {
			%>
			<li class="sidebar-item"><a
			...
			<li class="sidebar-item"><a
				...
				class="sidebar-link <%= about ? "active" : "" %>">About</a></li>
			<li class="sidebar-item"><a
				href="${pageContext.request.contextPath}/services"
				class="sidebar-link <%= services ? "active" : "" %>">Services</a></li>
			<li class="sidebar-item"><a
				href="${pageContext.request.contextPath}/contact"
				class="sidebar-link <%= contact ? "active" : "" %>">Contact</a></li>
		</ul>
	</div>
	...
	<div class="main-content">
		...
		<div class="info-hero">
			...
			<p>FitTrack Pro is a gym management platform built to connect
				administrators, trainers, and members in one clean workflow. It
				keeps member records, trainer assignments, attendance, and workout
				plans organized so the gym team can focus on coaching and member
				progress.</p>
		</div>
		<div class="info-grid">
			<div class="info-card">
				<h3>Our Mission</h3>
				<p>Help fitness centers run smoother with practical tools for
					memberships, training, attendance, and progress tracking.</p>
			</div>
			<div class="info-card">
				<h3>Role Based Access</h3>
				<p>Admins manage the operation, trainers manage coaching
					activity, and members view their own progress and plans.</p>
			</div>
			<div class="info-card">
				<h3>Built For Growth</h3>
				<p>The system is structured around clean records, simple
					workflows, and reliable reporting as your gym expands.</p>
			</div>
		</div>
		<%
		} else if (services) {
		...
		<div class="info-hero">
			<h1>Services</h1>
			<p>FitTrack Pro supports the core services a modern fitness
				facility needs every day, from onboarding members to assigning
				workout plans and tracking attendance.</p>
		</div>
		<div class="info-grid">
			<div class="info-card">
				<h3>Membership Management</h3>
				<p>Create, update, and monitor member accounts with status,
					expiry dates, health notes, and contact details.</p>
			</div>
			<div class="info-card">
				<h3>Trainer Management</h3>
				<p>Add trainers, maintain their specialties and profiles, and
					keep trainer records available to the admin team.</p>
			</div>
			<div class="info-card">
				<h3>Workout Planning</h3>
				<p>Trainers can create structured workout plans for members with
					dates, exercises, notes, and active status.</p>
			</div>
			<div class="info-card">
				<h3>Attendance Tracking</h3>
				<p>Record check-ins, track active sessions, and review
					attendance history for member engagement.</p>
			</div>
			<div class="info-card">
				<h3>Member Dashboard</h3>
				<p>Members can view membership status, fitness data, workout
					plans, and attendance history from one portal.</p>
			</div>
			<div class="info-card">
				<h3>Admin Oversight</h3>
				<p>Admins get a clear overview of members, trainers, active
					memberships, and operational activity.</p>
			</div>
		</div>
		<%
		} else {
		...
		<div class="info-hero">
			<h1>Contact Us</h1>
			<p>Need support, want to update gym information, or have a
				question about your account? Send a message to the FitTrack Pro
				team.</p>
		</div>
		<div class="contact-layout">
			<div class="info-card contact-list">
				<h3>Gym Support</h3>
				<p>
					<strong>Email:</strong> support@fittrackpro.com
				</p>
				<p>
					<strong>Phone:</strong> +977 9800000000
				</p>
				<p>
					<strong>Hours:</strong> Sunday-Friday, 6:00 AM - 8:00 PM
				</p>
				<p>
					<strong>Location:</strong> FitTrack Pro Fitness Center
				</p>
			</div>
			<div class="info-card">
