			...
			<div class="col-6">
				<div class="card">
					...
					<div class="card-body">
						...
						<p>
							<strong>Name:</strong>
							<%=trainer.getFullName()%></p>
						<p>
							<strong>Specialization:</strong>
							<%=trainer.getSpecialization()%></p>
						<p>
			...
			<div class="col-6">
				<div class="card">
					...
					<div class="card-body">
						<a
							href="${pageContext.request.contextPath}/trainer/create-workout"
							class="btn btn-primary btn-block">Create New Workout Plan</a> <a
							href="${pageContext.request.contextPath}/trainer/members"
							class="btn btn-outline btn-block" style="margin-top: 10px;">View
							All Members</a>
					</div>
				</div>
			</div>
