...
public class trainerDashboardServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if ("/trainer/attendance".equals(path)) {
                ...
                request.setAttribute("attendanceList", attendance.findByTrainerId(trainer.getTrainerId(), selectedMemberId));
    ...
    private void handleAttendancePost(HttpServletRequest request, HttpServletResponse response) throws IOException, SQLException {
        if (!"checkout".equalsIgnoreCase(request.getParameter("action"))) {
            response.sendRedirect(request.getContextPath() + "/trainer/attendance?error=" + url("Trainers can only check out active attendance sessions."));
            return;
        }
        ...
        if (trainer == null || attendanceId == null || !attendance.checkOutForTrainer(attendanceId, trainer.getTrainerId())) {
