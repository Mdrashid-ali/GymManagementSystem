...
/**
 * Performs workout plan database operations.
 */
public class workoutPlanService {
	...
	private List<workoutPlan> find(String where, int id) throws SQLException {
		String sql = "SELECT wp.*, CONCAT(t.first_name,' ',t.last_name) AS trainer_name, CONCAT(m.first_name,' ',m.last_name) AS member_name FROM workout_plans wp JOIN trainers t ON t.trainer_id=wp.trainer_id JOIN members m ON m.member_id=wp.member_id"
				+ where;
