...
<body>
    ...
    <div class="main-content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="addMemberForm" action="${pageContext.request.contextPath}/admin/add-member" method="post" novalidate>
                    <div id="memberValidationMessage" class="alert alert-danger member-validation-error" role="alert"></div>
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="firstName">First Name *</label>
                                <input type="text" id="firstName" name="firstName" class="form-control" data-required-message="Please enter the member first name.">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="lastName" name="lastName" class="form-control" data-required-message="Please enter the member last name.">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="email" id="email" name="email" class="form-control" data-required-message="Please enter the member email address.">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="tel" id="phone" name="phone" class="form-control" data-required-message="Please enter the member phone number.">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <div class="password-field">
                                    <input type="password" id="password" name="password" class="form-control" data-required-message="Please enter a password.">
    ...
    <svg class="eye-closed" viewBox="0 0 24 24" aria-hidden="true" style="display:none;"><path d="M17.94 17.94A10.94 10.94 0 0 1 12 19C5.5 19 2 12 2 12a20.28 20.28 0 0 1 5.06-5.94"></path><path d="M9.9 4.24A10.45 10.45 0 0 1 12 5c6.5 0 10 7 10 7a20.2 20.2 0 0 1-2.16 3.19"></path><path d="M14.12 14.12A3 3 0 0 1 9.88 9.88"></path><path d="M1 1l22 22"></path></svg>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select id="membershipType" name="membershipType" class="form-control" required>
                                    ...
                                    <option value="PREMIUM" selected>Premium - NPR 7,500/month</option>
        ...
        var memberMessage = document.getElementById('memberValidationMessage');
        var requiredMemberFields = ['firstName', 'lastName', 'email', 'phone', 'password'];

        function showMemberFieldError(input, message) {
        ...
        function clearMemberFieldError(input) {
            var error = document.querySelector('[data-error-for="' + input.id + '"]');
        ...
        addMemberForm.addEventListener('submit', function(event) {
            ...
            requiredMemberFields.forEach(function(fieldId) {
                var input = document.getElementById(fieldId);
                clearMemberFieldError(input);
                if (input.value.trim() === '') {
                    hasError = true;
                    showMemberFieldError(input, input.dataset.requiredMessage);
                    if (!firstInvalid) {
                        firstInvalid = input;
                    }
                }
            ...
            if (emailInput.value.trim() !== '' && !emailInput.checkValidity()) {
                hasError = true;
                showMemberFieldError(emailInput, 'Please enter a valid email address.');
                if (!firstInvalid) {
            ...
            if (passwordInput.value.trim() !== '' && !isStrongPassword(passwordInput.value)) {
                hasError = true;
                showMemberFieldError(passwordInput, passwordRuleMessage);
                if (!firstInvalid) {
            ...
            if (hasError) {
                ...
                memberMessage.textContent = 'Please complete the required member fields before submitting.';
