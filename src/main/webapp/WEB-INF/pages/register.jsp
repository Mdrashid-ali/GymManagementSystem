...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/style.css?v=register-icon-clear-15">
    <style>
...
<body>
    <main class="auth-container">
        <div class="auth-card auth-card-wide">
            ...
            <form id="registerForm" action="${pageContext.request.contextPath}/register" method="post" novalidate>
                <div id="registerValidationMessage" class="alert alert-danger register-validation-error" role="alert"></div>                <div class="row">
                    <div class="col-6">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <div class="password-field">
                                <input type="password" id="confirmPassword" name="confirmPassword" class="form-control" data-required-message="Please confirm your password.">
                ...
                <button type="submit" class="btn btn-primary btn-block auth-submit-spaced register-button">
                    <svg class="register-button-icon" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <script>
        ...
        var registerMessage = document.getElementById('registerValidationMessage');
        var requiredRegisterFields = ['firstName', 'lastName', 'email', 'phone', 'password', 'confirmPassword'];
        ...
        registerForm.addEventListener('submit', function(event) {
            ...
            requiredRegisterFields.forEach(function(fieldId) {
                ...
                if (input.value.trim() === '') {
                    hasError = true;
                    showRegisterFieldError(input, input.dataset.requiredMessage);
                    if (!firstInvalid) {
                        firstInvalid = input;
                    }
                }
            ...
            if (emailInput.value.trim() !== '' && !emailInput.checkValidity()) {
                hasError = true;
                showRegisterFieldError(emailInput, 'Please enter a valid email address.');
                if (!firstInvalid) {
            ...
            if (passwordInput.value.trim() !== '' && !isStrongPassword(passwordInput.value)) {
                hasError = true;
                showRegisterFieldError(passwordInput, passwordRuleMessage);
                if (!firstInvalid) {
            ...
            if (passwordInput.value && confirmInput.value && passwordInput.value !== confirmInput.value) {
                hasError = true;
                showRegisterFieldError(confirmInput, 'Password and confirmation do not match.');
